...
const steps = [
  {
    id: 1,
    title: "Start of the donation",
    description:
      "You have chosen to sponsor an orphan in Gaza. Your donation is ready to be sent.",
    delay: 3,
    pos: 1,
    img: box,
  },
  {
    ...
    description:
      "Computers are verifying that everything is correct (amount, recipient).",
    delay: 6,
    pos: 0,
    img: swap,
  },
  {
    ...
    description:
      "Your donation is now recorded in a secure registry. It can no longer be modified.",
    delay: 9,
    pos: 1,
    img: scan,
  },
  {
    ...
    description:
      "The money is being sent. You will receive proof (photos, videos, receipts).",
    delay: 12,
    pos: 0,
    img: check,
  },
